---
description: 免费云资源指南：按需求整理静态托管、Oracle Cloud 永久免费 VPS、数据库与后端即服务，以及学生专属云额度，并说明各家免费方案在账户要求和计费模型上的实际差异。
tags:
  - 云服务
  - 免费资源
  - 建站
...
6. 面向中国大陆公众的网站若部署在大陆服务器，需先确认 ICP 备案，并评估数据处理与跨境合规要求（见[域名申请与管理](./tech-domain.md#避坑提醒)）。
